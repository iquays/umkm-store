    ...
    <div class="row-fluid">
        <div class="col-md-3">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 cat-browser">
                    <h4 class="cat-title">JUMLAH PENGUNJUNG</h4>
                    <strong>Online: </strong><?= Yii::$app->userCounter->getOnline(); ?> pengunjung<br/>
                    <strong>Hari Ini: </strong><?= Yii::$app->userCounter->getToday(); ?> pengunjung<br/>
                    <strong>Kemarin: </strong><?= Yii::$app->userCounter->getYesterday(); ?> pengunjung<br/>
                    <strong>Total: </strong><?= Yii::$app->userCounter->getTotal(); ?> pengunjung<br/>
                </div>
            </div>
        </div>
        <div class="col-md-9">
                        ...
                        <div class="product-grid">
                            <a href="<?= Yii::$app->request->baseUrl . '/product/view?id=' . $fp['id'] ?>">
                                ...
                                if (isset($fp['productPictures'][0]['picture'])) {
                                    echo Html::img(Yii::$app->request->baseUrl . '/uploads/products/' . $fp['id'] . '/thumbnail/' . $fp['productPictures'][0]['picture'], ['alt' => $fp['product_name'], 'class' => 'img-rounded product-grid-image']);
                                } else {
