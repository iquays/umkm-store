        ...
        <div class="col-md-3">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 cat-browser">
                    ...
                    Hari Ini: <?php echo Yii::$app->userCounter->getToday(); ?><br/>
                    Kemarin: <?php echo Yii::$app->userCounter->getYesterday(); ?><br/>
                    ...
                    <div class="product-grid">
                        <a href="<?= Yii::$app->request->baseUrl . '/product/view?id=' . $sp['id'] ?>">
                            ...
                            if (isset($sp['productPictures'][0]['picture'])) {
                                echo Html::img(Yii::$app->request->baseUrl . '/uploads/products/' . $sp['id'] . '/thumbnail/' . $sp['productPictures'][0]['picture'], ['alt' => $sp['product_name'], 'class' => 'img-rounded product-grid-image']);
                            } else {
